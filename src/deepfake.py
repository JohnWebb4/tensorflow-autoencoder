...
if len(sys.argv) < 3:
    raise ValueError('Missing train folder path or test folder path')

train_folder_path = sys.argv[1]
test_folder_path = sys.argv[2]

train_file_paths = glob.glob('{}/*'.format(train_folder_path))
test_file_paths = glob.glob('{}/*'.format(test_folder_path))
